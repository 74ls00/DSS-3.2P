...
cls
set proname=DSS36
set propath=G:\home\Documents\Projects\EAGLE\DSS-36
...
rem set listtxt=%propath%\help\.gitignore

set listtxt=%~d0%~p0.gitignore
...
%bin7z% a -t7z -mx8 -m0=lzma2 -mmt=8 -ssw -scsWIN -r0 -x@%listtxt% %outfile% %propath% -xr!%incl% -xr!%incl2% -xr!%incl3% -xr!%incl4% -xr!%incl5% -xr!%incl6% -xr!%incl7%
